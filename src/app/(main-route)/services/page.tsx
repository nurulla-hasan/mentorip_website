    ...
    <div className="pb-20 space-y-24">
      ...
      <section className="relative md:h-[500px] py-8 md:py-0 rounded-4xl md:rounded-[3rem] overflow-hidden border border-border group/hero shadow-2xl">
        ...
        <div className="relative h-full flex flex-col items-center justify-center text-center px-6 max-w-4xl mx-auto space-y-10">
          ...
          <h1 className="text-xl md:text-7xl font-black text-foreground md:tracking-tighter md:leading-[0.9] transition-transform duration-700 group-hover/hero:scale-[1.02]">
      ...
      <section className="space-y-16">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
           <div className="space-y-4">
              ...
              <h3 className="text-4xl font-black text-foreground">World-Class Service Suite</h3>
           </div>
           <p className="max-w-md text-muted-foreground font-medium italic">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
           {serviceCategories.map((cat, i) => (
             <Card key={i} className="group border-border bg-card rounded-[2.5rem] p-8 hover:shadow-[0_20px_50px_rgba(56,189,248,0.08)] hover:-translate-y-2 transition-all duration-500 relative overflow-hidden flex flex-col justify-between cursor-pointer">
                ...
                <div className="relative space-y-6">
                   <div className="flex items-center justify-between">
                      <div className="w-14 h-14 rounded-2xl bg-muted flex items-center justify-center group-hover:bg-primary group-hover:rotate-360 transition-all duration-700">
                   ...
                   <div className="space-y-3">
                      <h4 className="text-lg font-black text-foreground tracking-tight italic group-hover:text-primary transition-colors">{cat.title}</h4>
      ...
      <section className="bg-muted rounded-[3rem] p-12 lg:p-20 border border-border shadow-2xl relative overflow-hidden group/process">
         ...
         <div className="relative max-w-5xl mx-auto space-y-20">
            <div className="text-center space-y-4">
              ...
              <h3 className="text-4xl font-black text-foreground">Our Methodical Approach</h3>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
               {processes.map((p, i) => (
                 <div key={i} className="relative group/step text-center space-y-6">
                    <div className="w-24 h-24 bg-card rounded-4xl border border-border flex items-center justify-center mx-auto shadow-xl group-hover/step:border-primary group-hover/step:rotate-12 group-hover/step:scale-110 transition-all duration-500 relative z-10">
                    ...
                    <div className="space-y-2">
                       <h5 className="text-lg font-black text-foreground uppercase tracking-tight group-hover/step:text-primary transition-colors">{p.title}</h5>
            ...
            <div className="p-10 lg:p-14 bg-card rounded-[3rem] border border-border shadow-2xl space-y-8 group hover:border-primary/50 hover:shadow-primary/5 transition-all duration-500 relative overflow-hidden">
               ...
               <div className="flex flex-col md:flex-row items-center gap-10">
                  ...
                  <div className="space-y-4 text-center md:text-left">
                     ...
                     <h4 className="text-3xl font-black text-foreground italic">Global IP Liaison Office</h4>
            ...
            <div className="p-10 lg:p-14 bg-muted rounded-[3rem] border border-border shadow-2xl space-y-8 group relative overflow-hidden hover:border-primary/50 hover:shadow-primary/5 transition-all duration-500">
               ...
               <div className="flex flex-col md:flex-row items-center gap-10 relative z-10">
                  ...
                  <div className="space-y-4 text-center md:text-left">
                     ...
                     <h4 className="text-3xl font-black text-foreground italic text-shadow-sm">Full-Spectrum Confidentiality</h4>
                     <p className="text-muted-foreground font-medium italic text-lg leading-relaxed">
      ...
      <section className="max-w-4xl mx-auto">
         <div className="bg-muted p-10 md:p-16 rounded-[3rem] border border-border text-center space-y-8 relative overflow-hidden shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] group/cta">
            ...
            <h4 className="text-2xl md:text-4xl font-black text-foreground uppercase tracking-tight group-hover:scale-[1.01] transition-transform">Ready to Secure Your Innovation?</h4>
            <p className="text-muted-foreground font-medium italic text-lg max-w-2xl mx-auto">
