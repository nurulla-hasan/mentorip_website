...
export default async function AboutPage() {
  ...
  return (
    <div className="pb-16 space-y-16">
      {/* Compact Page Header */}
      <section className="pb-4 border-b border-border/50 mb-4 -mx-4 px-4 md:-mx-8 md:px-8 bg-primary/5">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center -mx-4 px-4 md:-mx-8 md:px-8 bg-primary/10">
      ...
      {/* Timeline Section */}
      <section className="space-y-6 -mx-4 px-4 md:-mx-8 md:px-8 bg-primary/10">
      ...
      <section className="space-y-12 -mx-4 px-4 md:-mx-8 md:px-8 bg-primary/5">
      ...
      <section id="resources" className="space-y-6 -mx-4 px-4 md:-mx-8 md:px-8 bg-primary/5">
        <div className="text-center space-y-2">
          <Badge
            variant="outline"
